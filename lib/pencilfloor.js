...
customElements.define('pencilfloor-element', Pencilfloor);
...
createParams =>
{
    ...
    const pencilfloor = document.createElement('PENCILFLOOR-ELEMENT');
    ...
    (() =>
    {
        const shadowRoot = pencilfloor.attachShadow({ mode: 'open' });
        const base = shadowRoot.appendChild(document.createElement('SPAN'));
        return base;
    })();
    makeFocusable();
